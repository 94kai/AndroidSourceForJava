...
public final class ViewRootImpl implements ViewParent,
    ...
    // by xk 2017/8/8 23:26 调用invalidate
    @Override
    ...
    /**
     * 执行了mTraversalRunnable这个runnable
     * @author xk
     * @time 2017/8/8 23:29
     */
    ...
    /**
     * 终于看到了这一步，开发艺术中讲过这个方法，ViewRootImpl的关键方法
     * 关键方法 做了三件事 1.performMeasure(内部调用mView.measure()) 2.performLayout(内部调用mView.layout())
     * 3.performDraw(内部调用drawSoftware()->mView.draw())
     * @author xk
     * @time 2017/8/5 21:36
     */
    ...
    /**
     * 在这个方法中，创建Canvas，然后调用mView.draw(canvas),把canvas传进去，我们在view的onDraw中的canvas就是从这里来的
     * @author xk
     * @time 2017/8/9 07:58
     */
    /**
