...
public class PhoneWindow extends Window implements MenuBuilder.Callback {
    ...
    /**
     * 做了两件事 1.installDecor，创建DecorView, 2.mLayoutInflater.inflate(layoutResID,mContentParent)把我们的布局加载中content中
     * (下面那个方法是用的addview的方式)
     * @author xk
     * @time 2017/8/8 22:49
     */
    ...
    protected ViewGroup generateLayout(DecorView decor) {
        ...
        // by xk 2017/8/8 22:58 给mDecor中添加一个资源文件（layoutResource）的view，最简单的是一个线性布局（R.layout.screen_simple），里面有一个viewstub和framelayout（id为content），就是我们布局的根
        mDecor.onResourcesLoaded(mLayoutInflater, layoutResource);
        // by xk 2017/8/8 23:00 contnetParent就是帧布局，把他返回即可
    ...
    /**
     * 通过mDecor = generateDecor(-1);创建了一个DecorView（顶层view）
     * 通过调用mContentParent = generateLayout(mDecor);方法，返回一个帧布局，就是contentview那个布局，进去看
     *
     * @author xk
     * @time 2017/8/8 22:52
     */
